...
var usersGetCurrentUserProfileCmd = &cobra.Command{
	Use:   "get-current-user-profile",
	Short: "Get Current User's Profile ",
	RunE:  withTelemetry(runUsersGetCurrentUserProfile),
}

var usersGetCurrentUserProfileFlags struct {
}

func init() {

	usersCmd.AddCommand(usersGetCurrentUserProfileCmd)
}

func runUsersGetCurrentUserProfile(cmd *cobra.Command, args []string) error {
	...
	if rootFlags.schema {
		...
		schema := map[string]any{
			"command":     "get-current-user-profile",
	...
	req := &httpclient.Request{
		Method:      "GET",
		Path:        httpclient.SubstitutePath("/me", pathParams),
