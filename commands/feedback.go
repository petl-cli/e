...
const (
	...
	feedbackToken    = "1f10d27c-d4e6-45b3-b4c3-a3c7acd5a8e5"
)
...
Examples:
  spotify-web-api feedback "the --filter regex syntax is unclear"
  spotify-web-api feedback --about "create-widget" "exit code 0 but no output"
`,
