...
var usersUnfollowPlaylistCmd = &cobra.Command{
	Use:   "unfollow-playlist",
	Short: "Unfollow Playlist ",
	RunE:  withTelemetry(runUsersUnfollowPlaylist),
}

var usersUnfollowPlaylistFlags struct {
	playlistId string
}

func init() {
	usersUnfollowPlaylistCmd.Flags().StringVar(&usersUnfollowPlaylistFlags.playlistId, "playlist-id", "", "")
	usersUnfollowPlaylistCmd.MarkFlagRequired("playlist-id")

	usersCmd.AddCommand(usersUnfollowPlaylistCmd)
}

func runUsersUnfollowPlaylist(cmd *cobra.Command, args []string) error {
	...
	pathParams["playlist_id"] = fmt.Sprintf("%v", usersUnfollowPlaylistFlags.playlistId)
