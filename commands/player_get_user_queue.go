...
var playerGetUserQueueCmd = &cobra.Command{
	Use:   "get-user-queue",
	Short: "Get the User's Queue ",
	RunE:  withTelemetry(runPlayerGetUserQueue),
}

var playerGetUserQueueFlags struct {
}

func init() {

	playerCmd.AddCommand(playerGetUserQueueCmd)
}

func runPlayerGetUserQueue(cmd *cobra.Command, args []string) error {
	...
	req := &httpclient.Request{
		Method:      "GET",
		Path:        httpclient.SubstitutePath("/me/player/queue", pathParams),
