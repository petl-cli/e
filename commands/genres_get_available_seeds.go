...
var genresGetAvailableSeedsCmd = &cobra.Command{
	Use:   "get-available-seeds",
	Short: "Get Available Genre Seeds ",
	RunE:  withTelemetry(runGenresGetAvailableSeeds),
}

var genresGetAvailableSeedsFlags struct {
}

func init() {

	genresCmd.AddCommand(genresGetAvailableSeedsCmd)
}

func runGenresGetAvailableSeeds(cmd *cobra.Command, args []string) error {
	...
	req := &httpclient.Request{
		Method:      "GET",
		Path:        httpclient.SubstitutePath("/recommendations/available-genre-seeds", pathParams),
