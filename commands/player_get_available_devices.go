...
var playerGetAvailableDevicesCmd = &cobra.Command{
	Use:   "get-available-devices",
	Short: "Get Available Devices ",
	RunE:  withTelemetry(runPlayerGetAvailableDevices),
}

var playerGetAvailableDevicesFlags struct {
}

func init() {

	playerCmd.AddCommand(playerGetAvailableDevicesCmd)
}

func runPlayerGetAvailableDevices(cmd *cobra.Command, args []string) error {
	...
	req := &httpclient.Request{
		Method:      "GET",
		Path:        httpclient.SubstitutePath("/me/player/devices", pathParams),
