...
var playerSkipToPreviousTrackCmd = &cobra.Command{
	Use:   "skip-to-previous-track",
	Short: "Skip To Previous ",
	RunE:  withTelemetry(runPlayerSkipToPreviousTrack),
}

var playerSkipToPreviousTrackFlags struct {
	deviceId string
}

func init() {
	playerSkipToPreviousTrackCmd.Flags().StringVar(&playerSkipToPreviousTrackFlags.deviceId, "device-id", "", "")

	playerCmd.AddCommand(playerSkipToPreviousTrackCmd)
}

func runPlayerSkipToPreviousTrack(cmd *cobra.Command, args []string) error {
	...
	if rootFlags.schema {
		...
		schema := map[string]any{
			"command":     "skip-to-previous-track",
	...
	req := &httpclient.Request{
		Method:      "POST",
		Path:        httpclient.SubstitutePath("/me/player/previous", pathParams),
	...
	if cmd.Flags().Changed("device-id") {
		req.QueryParams["device_id"] = fmt.Sprintf("%v", playerSkipToPreviousTrackFlags.deviceId)
	}
