...
var marketsListAvailableCmd = &cobra.Command{
	Use:   "list-available",
	Short: "Get Available Markets ",
	RunE:  withTelemetry(runMarketsListAvailable),
}

var marketsListAvailableFlags struct {
}

func init() {

	marketsCmd.AddCommand(marketsListAvailableCmd)
}

func runMarketsListAvailable(cmd *cobra.Command, args []string) error {
	...
	req := &httpclient.Request{
		Method:      "GET",
		Path:        httpclient.SubstitutePath("/markets", pathParams),
